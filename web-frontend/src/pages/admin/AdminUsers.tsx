...
function fieldLabel(field?: string | null) {
  ...
  const labels: Record<string, string> = {
    ...
    volume_gvs: 'V ГВС',
    gspo_name: 'Наименование',
    actual_connection_point: 'Фактическая точка присоединения',
    standalone_address: 'Адрес',
    leader_name: 'Руководитель',
    phone: 'Телефон',
    metering_presence: 'Наличие узла учета',
    no_debt: 'Справка об отсутствии задолженности',
    power_of_attorney: 'Доверенность',
    contract: 'Договор',
    uute: 'Наличие УУТЭ',
    uute_verified: 'УУТЭ поверен',
    third_party_disconnection: 'Отключение третьими лицами',
    third_party_disconnection_note: 'Примечание по отключению',
